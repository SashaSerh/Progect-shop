export const translations = {
    ...
    "admin-remote-github-export-commit": "Экспорт JSON также обновляет products.json (GitHub)",
    ...
    "admin-remote-github-export-commit": "Експорт JSON також оновлює products.json (GitHub)",
