...
- Логотип масштабируется (CSS var) с кэшированием, избегаем лишних setProperty.
 - Жесты: edge-swipe open только у верхней кромки (по умолчанию ≤16px), угловая фильтрация (по умолчанию 35°) и минимальный горизонтальный сдвиг (8px).
...
- [ ] Не добавлять новые таймеры setInterval без крайней необходимости.
 - [x] Жесты меню: использовать passive listeners, will-change на время жеста, убирать inline-стили по завершении.
...
---
Последнее обновление: (обновите дату при правке) 2025-10-11
