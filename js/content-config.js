...
export const contentConfig = {
  ...
  portfolio: [
    // Замените позже своими фото и текстами
    {
      ...
      title: 'Монтаж сплит-системы в квартире',
      description: 'Установили инверторную сплит-систему с трассой 7м и скрытой прокладкой. Срок — 1 день.'
    },
    {
      src: 'https://placehold.co/480x320?text=Work+2',
      alt: 'Монтаж вентиляции — кейс 2',
      title: 'Вентиляция в частном доме',
      description: 'Проектирование и монтаж приточно-вытяжной системы с рекуперацией тепла. Срок — 3 дня.'
    },
    {
      src: 'https://placehold.co/480x320?text=Work+3',
      alt: 'Обслуживание систем — кейс 3',
      title: 'Сезонное обслуживание',
      description: 'Очистка теплообменника, проверка хладагента, диагностика узлов. Гарантия — 6 месяцев.'
    }
  ]
};
